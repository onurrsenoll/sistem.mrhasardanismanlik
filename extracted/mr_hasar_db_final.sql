...
CREATE TABLE IF NOT EXISTS users (
    ...
    totp_aktif TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS araclar (
    ...
    belge_tescil_no VARCHAR(50) DEFAULT NULL,
    onarim_gun_suresi INT DEFAULT NULL,
    gecmis_hasar ENUM('var','yok') DEFAULT NULL,
    surucu_ad VARCHAR(100) DEFAULT NULL,
    surucu_tc_kimlik VARCHAR(11) DEFAULT NULL,
    ruhsat_sahibi_surucu ENUM('ayni','farkli') DEFAULT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    INDEX idx_dosya (dosya_id),

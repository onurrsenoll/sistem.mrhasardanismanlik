...
/* ═══════════════════════════════════════════════════════════════
   EXPORT: Diğer modüller (örn: ihbar-foyu) bu OCR fonksiyonlarını
   doğrudan kullanabilsin. Birebir aynı OCR mantığı sağlanır.
   ═══════════════════════════════════════════════════════════════ */
MR._ruhsatOcr = {
  runClaudeOcr: runClaudeOcr,
  runEnhancedOcrOnImage: runEnhancedOcrOnImage,
  parseOcrText: parseOcrText,
  initTesseractWorker: initTesseractWorker,
  preprocessForOcr: typeof preprocessForOcr !== 'undefined' ? preprocessForOcr : null
};

...
/* ---------- EVRAK TÜRLERİ ---------- */
MR.EVRAK_T = [
  'NÜFUS KAYIT ÖRNEĞİ','VEKALETNAME','GELİR BELGESİ (ÖĞRENCİ BELGESİ)',
  'KİMLİK FOTOKOPİSİ','SÖZLEŞME','EPİKRİZ','VERASET İLAMI','SAĞLIK KURULU RAPORU',
  'RÜCU SÖZLEŞMESİ','ADLİ TIPÇI ONAYI','KUSUR BİLİRKİŞİ ONAYI','ONARIM FATURASI',
  'EKSPER RAPORU','ARAÇ KİLOMETRE BİLGİSİ','ARAÇ FOTOĞRAFLARI','DOSYA KAPAĞI',
  'TEMLİK','E-DEVLET ŞİFRESİ','SİGORTA POLİÇESİ','AZİLNAME','SİGORTA YAZIŞMALARI',
  'DİĞER EVRAKLAR','SGK EVRAĞI','KUSUR MÜTALAASI','ADLİ KURUL RAPOR MAKBUZU',
  'KATI RAPORU','TAHSİLAT DEKONTU','ARABULUCULUK TUTANAĞI','İPTAL MAİLİ',
  'KİŞİSEL VERİLERİ KORUMA KANUNU AÇIK RIZA BEYANI','TAHKİM REDD KARARI',
  'TEKLİF ONAY FORMU','BAŞVURU ALINDI DİLEKÇESİ','TEMİNAT MEKTUBU','NOTER TEMLİĞİ',
  'SENET','İÇ AZİLNAME','MESLEK BELGESİ','SAKATLIK MÜTALAASI',
  'ARAÇ DEĞER-PARÇA ANALİZ BİLİRKİŞİ RAPORU','BİLİRKİŞİ RAPOR MAKBUZU',
  'AVUKAT ONAYI','İHTARNAME','İŞÇİ ALACAKLARI FORMU','FİRMA BİLGİSİ',
  'PERT MUTABAKAT EVRAKI','KASKO','ARAÇ HASAR SMS SORGU EKRANI',
  'GEÇİCİ İŞ GÖREMEZLİK SORGU KAYDI','ARAÇ HASARI EKSPERTİZ GÖRÜŞÜ',
  'DİĞER-HARİCİ BELGE','İDARİ DAVA FORMU','DEPREM HASAR SORGULAMA','İKAMETGAH',
  'TAPU KAYDI BİLGİSİ','DASK','DEPREM EV RESİMLERİ','E NABIZ KAYITLARI',
  'ARABULUCULUK BAŞVURU FORMU','AZİLNAME İCRA TAKİP EVRAKLARI',
  'UZLAŞMA TUTANAKLARI-ADLİ','BEYANLAR','SİGORTA RIZA BEYANI','NOTER MAKBUZU',
  'RADYOLOJİK GÖRÜNTÜLER','SESLİ ONAY SES KAYDI','KTT','EHLİYET','RUHSAT',
  'ADLİ ALKOL RAPORU','GENEL ADLİ MUAYENE RAPORU','ÜCRET SÖZLEŞMESİ',
  'ŞİRKET İMZA SİRKÜSÜ','HAK MAHRUMİYETİ RÜCU SÖZLEŞMESİ','SBM TRAMER SORGUSU',
  'ARAÇ KİLOMETRE GÖSTEREN FOTOĞRAF','EHLİYET (İKİ TARAFIN ÖNLÜ ARKALI)',
  'RUHSAT (MAĞDUR VE KARŞI ARAÇ İKİSİDE OLACAK)',
  'POLİÇE (DOSYA TÜRÜNE GÖRE TRAFİK, KASKO)','EKSPERTİZ RAPORU',
  'HAK MAHRUMİYETİ RÜCU SÖZLEŞMESİ'
];

...
const MODUL_YETKILERI = [
  ...
  {modul: 'crm', label: 'CRM / SAHA', icon: 'Users', islemler: [
    /* 'crm-liste' kaldırıldı — menüden de kaldırıldı, 'crm-arama' aynı görevi görür. */
    {key: 'crm-yeni', label: 'YENİ CRM KAYIT'},
    {key: 'crm-duzenle', label: 'CRM KAYIT DÜZENLE'},
    {key: 'crm-sil', label: 'CRM KAYIT SİL'},
    {key: 'crm-toplu-sil', label: 'CRM TOPLU SİLME'},
    {key: 'crm-arama', label: 'ARAMA LİSTESİ GÖRÜNTÜLE'},
    {key: 'crm-arama-ekle', label: 'ARAMA LİSTESİ — KAYIT EKLE'},
    {key: 'crm-arama-duzenle', label: 'ARAMA LİSTESİ — KAYIT DÜZENLE / NOT'},
    {key: 'crm-arama-sil', label: 'ARAMA LİSTESİ — KAYIT SİL'},
    {key: 'crm-arama-excel', label: 'ARAMA LİSTESİ — EXCEL YÜKLEME'},
    {key: 'crm-arama-toplu-islem', label: 'ARAMA LİSTESİ — TOPLU DURUM GÜNCELLE'},
    {key: 'saha-liste', label: 'SAHA DOSYALARI LİSTESİ'},
    {key: 'saha-tumunu-gor', label: 'SAHA — TÜM PERSONEL KAYITLARINI GÖR'},
  ...
  {modul: 'cagri_merkezi', label: 'ÇAĞRI MERKEZİ', icon: 'PhoneCall', islemler: [
    {key: 'widget-goruntule', label: 'GELEN ÇAĞRI WİDGET (Çağrı gelince ekranda gösterir)'},
    {key: 'cagri-yap', label: 'GİDEN ARAMA YAPMA'}
  ]},

...
MR._CRMListesiInner = ({setPage, user}) => {
  ...
  const thSt = {padding: '12px 10px', textAlign: 'left', color: MR.tema==='koyu' ? '#cbd5e1' : C.textMuted, fontWeight: 800, fontSize: 11, borderBottom: `2px solid ${C.border}`, letterSpacing: 0.3};
  const iconBtn = (bg) => ({
...
MR._CRMDetayInner = ({setPage, crmId}) => {
  ...
  return (
    <div className="fade-in">
      {/* GERİ BUTONU */}
      <button style={{...S.btn, ...S.btnG, marginBottom: 16, fontSize: 11}} onClick={() => setPage('crm-arama')}>
      ...
      <div style={{display:'flex', gap:12, alignItems:'flex-start'}}>
        ...
        <div style={{width:260, minWidth:260, flexShrink:0}}>
          ...
          <div style={{display:'flex', alignItems:'center', gap:8, marginBottom:10, flexWrap:'wrap'}}>
            <button style={{...S.btn, ...S.btnG, fontSize:9, padding:'5px 10px', borderRadius:7}} onClick={() => setPage('crm-arama')}>

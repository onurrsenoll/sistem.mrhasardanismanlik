...
$GLOBALS['YETKI_MAP'] = array(
    ...
    // ─── YÖNLENDIRME (ARAMA LİSTESİ / ÇAĞRI KONTROL PANELİ) ───
    // Not: Arama Listesi, CRM/SAHA menüsü altında ve CRM modülüne bağlıdır.
    'yonlendirme/list.php' => array('crm', 'crm-arama'),
    'yonlendirme/get.php' => array('crm', 'crm-arama'),
    'yonlendirme/create.php' => array('crm', 'crm-arama-ekle'),
    'yonlendirme/delete.php' => array('crm', 'crm-arama-sil'),
    'yonlendirme/update.php' => array('crm', 'crm-arama-duzenle'),
    'yonlendirme/import.php' => array('crm', 'crm-arama-excel'),
    'yonlendirme/not-ekle.php' => array('crm', 'crm-arama-duzenle'),
    'yonlendirme/toplu-islem.php' => array('crm', 'crm-arama-toplu-islem'),

    // ─── ÇAĞRI MERKEZİ (WEBRTC / NETSANTRAL ENTEGRASYONU) ───
    'cagri/widget-goruntule.php' => array('cagri_merkezi', 'widget-goruntule'),

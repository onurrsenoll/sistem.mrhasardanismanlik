...
/* ---------- EVRAK TÜRLERİ ---------- */
MR.EVRAK_T = [
  'EHLİYET (İKİ TARAFIN ÖNLÜ ARKALI)',
  'RUHSAT (MAĞDUR VE KARŞI ARAÇ)',
  'POLİÇE (TRAFİK / KASKO)',
  'SİGORTA POLİÇESİ',
  'EKSPERTİZ RAPORU',
  'ARAÇ HASARI EKSPERTİZ GÖRÜŞÜ',
  'ARAÇ FOTOĞRAFLARI',
  'ARAÇ KİLOMETRE GÖSTEREN FOTOĞRAF',
  'ONARIM FATURASI',
  'SBM TRAMER SORGUSU',
  'ARAÇ HASAR SMS SORGU EKRANI',
  'ARAÇ DEĞER - PARÇA ANALİZ BİLİRKİŞİ RAPORU',
  'KUSUR MÜTALAASI',
  'KUSUR BİLİRKİŞİ ONAYI',
  'BİLİRKİŞİ RAPOR MAKBUZU',
  'KASKO',
  'PERT MUTABAKAT EVRAKI',
  'TEMLİK',
  'NOTER TEMLİĞİ',
  'NÜFUS KAYIT ÖRNEĞİ',
  'VERASET İLAMI',
  ...
  'GENEL ADLİ MUAYENE RAPORU',
  'ADLİ ALKOL RAPORU',
  'KATİ RAPORU',
  'ADLİ KURUL RAPOR MAKBUZU',
  'ADLİ TIPÇI ONAYI',
  'SAKATLIK MÜTALAASI',
  'RADYOLOJİK GÖRÜNTÜLER',
  'E-NABIZ KAYITLARI',
  'SGK EVRAĞI',
  'GEÇİCİ İŞ GÖREMEZLİK SORGU KAYDI',
  'GELİR BELGESİ (ÖĞRENCİ BELGESİ)',
  'MESLEK BELGESİ',
  'KTT (KAZA TESPİT TUTANAĞI)',
  'İŞÇİ ALACAKLARI FORMU',
  'VEKALETNAME',
  'KİMLİK FOTOKOPİSİ',
  'ÜCRET SÖZLEŞMESİ',
  'SÖZLEŞME',
  ...
  'UZLAŞMA TUTANAKLARI - ADLİ',
  'İPTAL MAİLİ',
  'KİŞİSEL VERİLERİ KORUMA KANUNU AÇIK RIZA BEYANI',
  'SESLİ ONAY SES KAYDI',
  'TAHKİM REDD KARARI',
  'TEKLİF ONAY FORMU',
  'BAŞVURU ALINDI DİLEKÇESİ',
  'TEMİNAT MEKTUBU',
  'SENET',
  'AVUKAT ONAYI',
  'İHTARNAME',
  ...
  'ŞİRKET İMZA SİRKÜSÜ',
  'İDARİ DAVA FORMU',
  'KYOK (KOVUŞTURMAYA YER OLMADIĞINA DAİR KARAR)',
  'TAPU KAYDI BİLGİSİ',
  'DASK',
  'DEPREM HASAR SORGULAMA',
  'DEPREM EV RESİMLERİ',
  'DİĞER - HARİCİ BELGE',
  'DİĞER EVRAKLAR',

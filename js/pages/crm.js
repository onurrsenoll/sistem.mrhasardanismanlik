    ...
    <div className="fade-in">
      ...
      <div style={{display:'flex', gap:12, alignItems:'flex-start'}}>
        ...
        <div style={{width:260, minWidth:260, flexShrink:0}}>
          ...
          {/* ÇAĞRI PANELİ — Yetki Yönetimine bağlı.
              Admin her zaman görür; diğerleri 'crm-ara' (TELEFON İLE ARAMA YAP)
              yetkisi varsa görür. Yetki verilmediyse panel gizli kalır. */}

...
// v2.1: Soft-delete filtresi (varsayılan: yalnız aktif dosyalar)
// d.silindi kullanıyoruz (view güncellenmeye gerek yok — list.php zaten LEFT JOIN dosyalar d yapıyor)
$includeSilinen = isset($_GET['silinen']) && $_GET['silinen'] === '1' && $user['rol'] === 'admin';
if (!$includeSilinen) {
    $where[] = '(d.silindi = 0 OR d.silindi IS NULL)';
}

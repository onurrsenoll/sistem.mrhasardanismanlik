...
try {
    ...
    // v2.1: oturumlar tablosuna kaydet + refresh token üret
    ...
    error_log('[mr_hasar] login error: ' . $e->getMessage());
    http_response_code(500);
    $resp = ['success' => false, 'error' => 'Sunucu hatasi'];
    if (!(defined('MR_IS_PROD') && MR_IS_PROD)) $resp['detail'] = $e->getMessage();

...
MR.cagriWidgetYetkili = function(user) {
  ...
  // v2.5.6 fix: ses çalıyor ama widget görünmüyor sorunu — santral kullanan
  // tüm temel rollerin (admin/uzman/personel) widget'ı görmesi sağlanır.
  // Önceki sürümde sadece admin doğrudan görüyordu; diğer roller netsantral_*
  // veya cagri_* yetkisinin tanımlı olmasını gerektiriyordu — bu yetkiler
  // sistem tarafından kullanıcılara verilmediği için widget render edilmiyordu.

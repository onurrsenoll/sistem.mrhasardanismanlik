/**
 * MR HASAR DANIŞMANLIK — DOSYA YENİ (v2.12)
      ...
      <SecCard icon="User" title="MAĞDUR BİLGİLERİ" sub="Mağdur kişiye ait bilgiler" color="#3b82f6" badge="ZORUNLU">
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr',gap:8}}>
          <FormGroup label="ADI SOYADI *"><input style={S.input} value={form.ad_soyad} onChange={e=>{
            ...
            /* v2.12: Mağdur Adı yazılınca MAĞDUR ARAÇ SAHİBİ (ma_ruhsat) otomatik dolar.
          ...
          <FormGroup label="T.C. KİMLİK NO *"><input style={S.input} value={form.tc_kimlik} onChange={e=>{
            const yeni = e.target.value;
            /* v2.12: Mağdur TC yazılınca RUHSAT SAHİBİ TC (ma_tc) otomatik dolar.
             * Kullanıcı manuel farklı bir değer girdiyse override etme. */
            setForm(p => ({
              ...p,
              tc_kimlik: yeni,
              ma_tc: (!p.ma_tc || p.ma_tc === p.tc_kimlik) ? yeni : p.ma_tc
            }));
          ...
          <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:10}}>
            ...
            <div style={{border:`1px solid ${C.border}`,borderRadius:10,overflow:'hidden'}}>
              ...
              <div style={{padding:10,display:'grid',gridTemplateColumns:'1fr 1fr',gap:8}}>
                ...
                <FormGroup label="RUHSAT SAHİBİ"><input style={S.input} value={form.ma_ruhsat} onChange={e=>u('ma_ruhsat',e.target.value)}/></FormGroup>
                <FormGroup label="RUHSAT SAHİBİ TC"><input style={S.input} value={form.ma_tc} onChange={e=>u('ma_tc',e.target.value)} maxLength={11}/></FormGroup>

/**
 * MR HASAR DANIŞMANLIK — DOSYA DETAY (v2.17)
...
/* v2.17: DOSYA YENİ ile uyumlu 5 yeni + 2 eski kaynak (geriye uyumluluk için ikisi de) */
const KAYNAKLAR = ['OFİS CRM','SERVİS','KAPORTACI','ACENTE','PASİF TEMSİLCİ','DİĞER','PAYDAŞ/YÖNLENDİREN'];
...
MR.DosyaDetayPage = ({dosyaId, setPage, user}) => {
  ...
  const openEditModal = () => {
    ...
    setEditForm({
      ...
      /* v2.14: magdur_telefon2, magdur_email, magdur_il, magdur_ilce, magdur_cinsiyet, magdur_meslek kaldırıldı */

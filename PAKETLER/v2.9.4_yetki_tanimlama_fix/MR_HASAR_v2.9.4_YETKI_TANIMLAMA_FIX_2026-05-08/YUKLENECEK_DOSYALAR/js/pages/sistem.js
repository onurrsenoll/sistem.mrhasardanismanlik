...
const MODUL_YETKILERI = [
  ...
  {modul: 'paydaslar', label: 'PAYDAŞLAR / ORTAKLAR', icon: 'Handshake', islemler: [
    /* v2.9.4: yeni route'lar yetki listesine eklendi */
    {key: 'is-ortaklari', label: 'İŞ ORTAKLARI (PERSONEL + AVUKAT)'},
    {key: 'is-paydaslari', label: 'İŞ PAYDAŞLARI (SERVİS/KAPORTACI/ACENTE/PASİF/DİĞER)'},
    {key: 'paydaslar-eksper-sigorta', label: 'EKSPER & SİGORTA'},
    /* eski route'lar geri uyumluluk için korundu */
    {key: 'ortaklar-ortaklar', label: 'İŞ ORTAKLARI (eski)'},
    {key: 'ortaklar-paydaslar', label: 'İŞ PAYDAŞLARI (eski)'},
  ...
  {modul: 'muhasebe', label: 'MUHASEBE', icon: 'Landmark', islemler: [
    ...
    {key: 'muhasebe-mahsup', label: 'MAHSUP ZİNCİRİ'},

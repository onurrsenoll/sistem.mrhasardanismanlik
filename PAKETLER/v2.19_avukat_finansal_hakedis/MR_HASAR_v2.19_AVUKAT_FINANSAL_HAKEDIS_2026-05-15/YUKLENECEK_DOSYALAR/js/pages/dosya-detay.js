/**
 * MR HASAR DANIŞMANLIK — DOSYA DETAY (v2.19)
    ...
    <div className="fade-in">
      ...
      {tab === 'bilgi' && (
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:14}}>
          {/* v2.19: Görsel tema iyileştirildi — başlıklarda gradient, ikon arka planı, daha vurgulu */}
          {/* SOL: DOSYA BİLGİLERİ */}
          <div style={{...S.card, background:`linear-gradient(180deg, ${C.bgCard} 0%, ${C.bgCard} 100%)`, boxShadow:`0 2px 8px ${C.accent}15`}}>
            <div style={{padding:'14px 16px',borderBottom:`2px solid ${C.accent}33`,display:'flex',alignItems:'center',gap:10,background:`linear-gradient(90deg, ${C.accent}15 0%, transparent 100%)`}}>
              ...
              <span style={{fontSize:13,fontWeight:800,letterSpacing:0.4,color:C.accent}}>DOSYA BİLGİLERİ</span>
            </div>
            <div style={{padding:'10px 14px'}}>
              ...
              {/* v2.19: AVUKAT ÖDEME ORANI gizlendi — sadece DOSYA HESABI sayfasında hesaplamada kullanılır */}
              {!isAvukat && <InfoRow label="SORUMLU" value={dosya.sorumlu_adi}/>}
              {/* v2.18: PAYDAŞ artık görüntülemede */}
              ...
              {/* v2.18: KAZA İLÇE artık görüntülemede */}
              ...
              {/* v2.18: NOTER VEKALET artık görüntülemede */}
              ...
              {/* v2.18: SİGORTA & EKSPER & SERVİS bölümü görüntülemede */}
              ...
              {/* v2.18: BH SÜRÜCÜ & SAKATLIK alanları görüntülemede */}
              {dosya.dosya_turu === 'BH' && (dosya.surucu_ad || dosya.surucu_ehliyet || dosya.surucu_kusur || dosya.sakatlik_aciklama) && (
                <div style={{marginTop:10,paddingTop:10,borderTop:`1px dashed ${C.border}`}}>
          ...
          <div style={{display:'flex',flexDirection:'column',gap:12}}>
            ...
            <div style={S.card}>
              ...
              <div style={{padding:'10px 14px'}}>
                {/* v2.18: TELEFON 2, İL, İLÇE, MESLEK, CİNSİYET, E-POSTA, ADRES tamamen kaldırıldı */}
                ...
                {magdur.gelir_tutari && <InfoRow label="GELİR TUTARI" value={fmt(magdur.gelir_tutari)}/>}
              </div>
            </div>

            {/* MAĞDUR ARAÇ BİLGİLERİ (v2.18: ADK/MDK/BH her üçü için, KASKO eklendi) */}
            {(dosya.dosya_turu === 'ADK' || dosya.dosya_turu === 'MDK' || dosya.dosya_turu === 'BH') && (arac.plaka || getPlaka()) && (
              <div style={S.card}>
                <div style={{padding:'10px 14px',borderBottom:`1px solid ${C.border}`,display:'flex',alignItems:'center',gap:8,background:`${C.warning}06`}}>
                  ...
                  <span style={{fontSize:12,fontWeight:800,fontFamily:'monospace',color:C.warning,marginLeft:'auto'}}>{arac.plaka || getPlaka()}</span>
                </div>
                <div style={{padding:'10px 14px'}}>
                  <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'0 16px'}}>
                    <InfoRow label="PLAKA" value={arac.plaka || getPlaka()} mono bold/>
            ...
            {(dosya.dosya_turu === 'ADK' || dosya.dosya_turu === 'MDK') && karsiArac.plaka && (
              <div style={S.card}>
                ...
                <div style={{padding:'10px 14px'}}>
                  <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'0 16px'}}>
                    {/* v2.18: PLAKA satırda, POLİÇE NO kaldırıldı */}
                    <InfoRow label="PLAKA" value={karsiArac.plaka} mono bold/>
            ...
            {/* v2.19: FİNANSAL ÖZET bölümü BİLGİ'den KALDIRILDI — artık DOSYA HESABI sekmesinin içinde */}
          </div>
        </div>
      )}

/**
 * MR HASAR DANIŞMANLIK — DOSYA YENİ (v2.19)
 * v2.19: AVUKAT görsel kartı UI'dan tamamen kaldırıldı. otoAvukat backend'de
 * ortak_id'ye otomatik atanmaya devam eder (ADK/MDK→Demirhan, BH→Emre).
 *
 * v2.18:
 * v2.18 değişiklikleri:
 *   - Mağdur'dan TAMAMEN kaldırıldı: E-Posta, Adres, İl, İlçe, Cinsiyet,
 *     Meslek, Telefon 2 (state + UI + backend INSERT)
 *
...
MR.DosyaYeniPage = ({setPage, user}) => {
  ...
  const [form, setForm] = useState({
    // Mağdur bilgileri (v2.18: adres, il, ilce, meslek, email, cinsiyet, telefon2 KESINLIKLE kaldırıldı)
    ad_soyad:'', tc_kimlik:'', telefon:'', iban:'', dogum_tarihi:'',
    // Dosya bilgileri
    dosya_turu:'ADK', kaza_tarihi:'', kaza_il:'', kaza_ilce:'', haklilik:'100', hak_mahrumiyet:'0', komisyon:'',
  ...
  return (
    <div style={{maxWidth:900,margin:'0 auto',paddingBottom:80}} className="fade-in">
      ...
      <SecCard icon="FileText" title="DOSYA BİLGİLERİ" sub="Tür, tarih, sorumluluk ve sigorta" color="#f97316" badge="ZORUNLU">
        ...
        {/* v2.19: AVUKAT görsel kartı KALDIRILDI. otoAvukat backend'de form.ortak_id'ye atanmaya devam eder
           (dosya türüne göre otomatik). Sadece UI gösterimi gizlendi. */}
      </SecCard>
